...
//import CollagenImmune.VectorField;
...
public class FFTGrid {
    ...
    public void Set(int x, int y, double val) {
        REAL.Set(x, y, val);
        IMAG.Set(x, y, 0); // zeros for Imag.
    }

    public void Set(int i, double val) {
        REAL.Set(i, val);
        IMAG.Set(i, 0); // zeros for Imag.
    }
    ...
    // element-wise multiplication of two FFT-transformed Grids
    public void ElementwiseMultiplication(FFTGrid grid2) {
        double r1,r2,i1,i2;
        for (int row = 0; row < REAL.xDim; row++) {
            for (int col = 0; col < REAL.yDim; col++) {
                r1 = REAL.Get(row,col);
