...
public class Deterministic1Player extends DeterministicNPlayer {
    ...
    Deterministic1Player(String filename, int sideLength, double deltaT, int scalefactor, double ClipMax) {
    ...
    public Deterministic1Player(String filename, int sideLength, double deltaT, int scalefactor, boolean[] vis_options, double ClipMax) {
