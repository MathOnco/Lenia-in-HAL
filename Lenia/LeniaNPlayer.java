...
public class LeniaNPlayer extends LeniaBaseClass implements Iterable<Grid2Ddouble> {
    ...
    LeniaNPlayer(String filename, int sideLength, double deltaT, int nPlayers, int scalefactor,int ClipMax) {
    ...
    LeniaNPlayer(String filename, int sideLength, double deltaT, int nPlayers, int scalefactor, boolean[] vis_options, double ClipMax) {
